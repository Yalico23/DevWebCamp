...
class Email{
    ...
    public function EnviarConfirmacion()
    {
        ...
        $mail->addAddress($this->email, 'DevWebCamp.com'); //para quien
        ...
        $contenido = "<html>
                ...
                <body>
                    ...
                    <p>Has creado tu cuenta en DevWebCamp. Para confirmar tu cuenta, por favor presiona el siguiente enlace:</p>
                    <p><a href='" . $_ENV['PROJECT_URL'] . "/confirmar?token=" . $this->token . "'>Confirmar Cuenta</a></p>
